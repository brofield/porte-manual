...
<xsl:template match="PARA">
	<xsl:variable name="pringNumber2">
		<xsl:number format="1" level="any" count="PARA"/>
	</xsl:variable>
	<xsl:element name="div">
		<xsl:attribute name="id">bm<xsl:value-of select="$pringNumber2" /></xsl:attribute>
		<table width="100%" cellspacing="0" cellpadding="0">
			<xsl:attribute name="id">bar<xsl:value-of select="$pringNumber2" /></xsl:attribute>
						...
						<tr>
							<td width="5%" class="blue">
								<xsl:element name="input">
									...
									<xsl:attribute name="name">check<xsl:value-of select="$pringNumber2" /></xsl:attribute>
									<xsl:attribute name="value">checkbox</xsl:attribute>
									<xsl:attribute name="style">display:none</xsl:attribute>
								</xsl:element>
							</td>
							<td width="80%" class="blue" align="center"><xsl:value-of select="TITLE" /></td>
				...
				<td align="center" class="gray">
					<table border="0" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							...
							<td width="80%" class="gray" align="center"><xsl:value-of select="TITLE" /></td>
		...
		<xsl:element name="div">
			<xsl:attribute name="class">frame</xsl:attribute>
				<xsl:element name="span">
					<xsl:attribute name="onClick">javascript:treeMenu('tm<xsl:value-of select="@INFOID"/>');chgImg('im<xsl:value-of select="@INFOID"/>');</xsl:attribute>
					...
					<xsl:attribute name="style">cursor:hand;color:#1B6384;text-decoration = 'underline'</xsl:attribute>
						<xsl:element name="img">
							...
							<xsl:attribute name="id">im<xsl:value-of select="@INFOID"/></xsl:attribute>
				...
				<br/>
			<xsl:element name="a">
				<xsl:attribute name="name"><xsl:value-of select="$pringNumber2" /></xsl:attribute>
			</xsl:element>
			<xsl:element name="div">
				<xsl:attribute name="style">display:none</xsl:attribute>
				<xsl:attribute name="id">tm<xsl:value-of select="@INFOID"/></xsl:attribute>
				<xsl:apply-templates />
			</xsl:element>
		</xsl:element>
	</xsl:element>
...
<!-- 印刷用変数宣言 -->
<xsl:variable name="printNumber" select="count(//PARA)"/>
